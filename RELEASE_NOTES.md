...
| Datei | Beschreibung |
| :--- | :--- |
| **[`Luxanix.exe`](https://github.com/BuzziGHG/Luxanix/releases/download/v1.0.0/Luxanix.exe)** | **Standalone Launcher:** Vorkompilierte Windows 64-Bit Desktop-App (Doppelklick zum Starten). |
| **[`Luxanix-Windows-v1.0.0.zip`](https://github.com/BuzziGHG/Luxanix/releases/download/v1.0.0/Luxanix-Windows-v1.0.0.zip)** | **Komplettpaket:** Enthält `Luxanix.exe`, alle Module (`engine/`, `ui/`), Presets und Setup-Skripte. |
...
- **Grafikkarte:** NVIDIA GeForce RTX 2060 oder höher (optimal: RTX 3080 Ti / RTX 40-Serie)
- **NVIDIA Treiber:** 535.xx oder neuer (CUDA 12.x kompatibel)
